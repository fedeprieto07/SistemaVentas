...
namespace Datos22
{
    public class dIngreso
    {
        ...
        public string Insertar(Ingreso Ingreso, List<Detalle_Ingreso> Detalle)
        {
            string rpta = "";
            ...
            try
            {
                ...
                if (rpta.Equals("OK"))
                {
                    dDetalle_Ingreso deting = new dDetalle_Ingreso();
                    Ingreso.Idingreso = Convert.ToInt32(SqlCmd.Parameters["@idingreso"].Value);
                    foreach (Detalle_Ingreso det in Detalle)
                    {
